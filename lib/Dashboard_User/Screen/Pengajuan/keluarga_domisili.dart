...
import 'package:mobile_kepuharjo_new/Dashboard_User/Screen/Pengajuan/pengajuan_domisili.dart';
...
class DaftarKeluargaDomisili extends StatefulWidget {
  final Surat selectedSurat;
  const DaftarKeluargaDomisili({required this.selectedSurat, Key? key})
      : super(key: key);

  @override
  State<DaftarKeluargaDomisili> createState() => _DaftarKeluargaState();
}

class _DaftarKeluargaState extends State<DaftarKeluargaDomisili> {
