...
class _PengajuansuratState extends State<Pengajuansuratkk> {
  ...
  void verifypengajuan() {
    if (keperluan.text.isEmpty) {
      ...
      Fluttertoast.showToast(
          msg: "Silahkan upload foto surat nikah anda",
          backgroundColor: black.withOpacity(0.7));
    } else if (imageAktaCerai == null) {
      Fluttertoast.showToast(
          msg: "Silahkan upload foto akta cerai anda",
          backgroundColor: black.withOpacity(0.7));
    } else {
